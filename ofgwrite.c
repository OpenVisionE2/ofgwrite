...
const char ofgwrite_version[] = "4.5.8";
int flash_kernel  = 0;
int flash_rootfs  = 0;
int no_write      = 0;
int force_e2_stop = 0;
...
int main(int argc, char *argv[])
{
	...
	if (flash_rootfs)
	{
		...
		if (!no_write && stop_e2_needed)
		{
			...
			ret = system("killall -9 kodi.bin");
			ret = system("killall -9 hddtemp");
			ret = system("killall -9 transmission-daemon");
			ret = system("killall -9 openvpn");
